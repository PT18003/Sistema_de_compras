    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="container card-body ">                  
                <div class="branding">
                <h1>Editar Articulo del Proveedor <b> {{$articuloProveedor->Proveedor->nombre}}</b></h1>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <div class="card card-inverse card-info">
                                <img class="card-img-top"src="{{$articuloProveedor->catalogo->imagen}}" alt="...">
                                <div class="ml-3 mt-3">
                                    <h4 class="card-title"><b>{{$articuloProveedor->catalogo->nombre}}</b></h4>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"> 
                                    <div class="card-text">
                                        {{$articuloProveedor->catalogo->descripcion}}
                                    </div>
                                    </li>
                                </ul>
                            </div>
